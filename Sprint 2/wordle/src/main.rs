...
fn main() {
    ...
    let easy_words = vec!["cat", "dog", "bat", "hat", "rat", "bread
    ", "chair", "dance", "earth", "fruit", "green", "house", "light", "mouse"];

    let medium_words = vec!["apple", "grape", "peach", "water", "cleanse", "bright", "castle"
    , "dragon", "garden", "puzzle", "rocket", "shadow", "silver", "window", "zebra"];

    let hard_words = vec!["pineapple", "strawberry", "blueberry", "raspberry", "Prestige", "Excaliber"
    , "absurd", "beacon", "cryptic", "enigma", "galaxy", "knight", "mirage", "phoenix", "wizard"];
    ...
    let mut attempts = word.len() + 2; // Set the number of attempts (word length + 5)
